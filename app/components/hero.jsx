  ...
  return (
    <section id='home' className="lg:h-screen md:gradient-background">
      ...
      <div className="z-10 flex flex-col md:justify-center p-5 gap-0">
          <h1
            color="#FFE8FE"
            className="font-mainheading text-secondaryBg text-[2.2rem] md:text-[3rem] lg:text-[5rem] leading-none"
          >
            Bursting with <br/> <span className='font-pacifico flavour-gradient text-[2rem] md:text-[3rem] lg:text-[5rem]'>Flavour,</span>
          </h1>
       
          <h1
            color="#FFE8FE"
            className="font-mainheading text-[#5523a0] text-[2.2rem] md:text-[3rem] lg:text-[5rem] leading-none"
          >
