...
const About = () => {
  return (
    <div className="gradient-background text-primaryBg h-screen w-full flex flex-col items-center justify-center p-4 md:p-10">
      ...
      <h1 className="font-pacifico mt-0 mb-5 p-0 leading-none text-4xl md:text-[680%]">
        Welcome to Mehboba.
      </h1>
      <div className="flex flex-col md:flex-row items-center md:items-start justify-center">
        <h1 className="font-mainheading mt-0 mb-5 p-0 md:pr-5 leading-none text-3xl md:text-[680%] text-center md:text-left">
          Celebrate Every
        </h1>
        ...
        <h1 className="font-mainheading mt-0 mb-5 p-0 md:pl-5 leading-none text-3xl md:text-[680%] text-center md:text-left">
          Sip of Our
        </h1>
      </div>
      <div className="flex flex-col md:flex-row items-center md:items-start justify-center">
        <h1 className="font-mainheading mt-0 mb-10 p-0 md:px-5 leading-none text-3xl md:text-[680%] text-center md:text-left">
      ...
      <div className="items-center justify-center p-4 md:p-8 w-full md:w-4/5">
        <p className="text-base md:text-lg text-justify leading-relaxed font-content">
